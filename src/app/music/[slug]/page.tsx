...
export function generateMetadata(): Metadata {
  return {
    title: `${SAMPLE_SONG.title} — ${SAMPLE_SONG.artist}`,
    description: `Listen to "${SAMPLE_SONG.title}" by ${SAMPLE_SONG.artist}. Stream, watch the video, read the lyrics and the story behind the song.`,
  };
}
